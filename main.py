...
TEST_MODE = False
AI_DELAY = 1
B_DIFFICULTY = int(input("DIfficulty of black:"))

W_DIFFICULTY = int(input("difficulty of white: "))

# Board Setup
G.BOARD_FEN = '4kb1r/p2n1ppp/4q3/4p1B1/4P3/1Q6/PPP2PPP/2KR4'
